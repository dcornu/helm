...
/**
  * The Helm service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelmService.
  */
trait HelmService extends Service {
  ...
  override final def descriptor = {
    ...
    named("helm")
      ...
      .withTopics(
        topic(HelmService.TOPIC_NAME, greetingsTopic)
